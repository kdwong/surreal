...
\begin{proof}
  ...
  In the equivalence branch, a smaller \(B\)-assertion replaces the equivalent
  \(x\)-slot after the strict \(y\)-movement.  The direction of movement in a
  slot reverses when the other selected option lies on the opposite side.
